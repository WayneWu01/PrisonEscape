...
[RealtimeModel]
public partial class ActiveSyncModel
{
...
public partial class ActiveSyncModel : RealtimeModel {
    public bool active {
        get {
    ...
    public delegate void PropertyChangedHandler<in T>(ActiveSyncModel model, T value);
    ...
    public ActiveSyncModel() : base(null) {
