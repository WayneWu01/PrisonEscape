    ...
    public class PackageManager {
        ...
        private static void CheckIfPackageExists() {
            if (__listRequest != null) {
                UnityEngine.Debug.LogError("Normcore Package Manager: List request already running. Ignoring.");
                return;
            }

            if (__debugLogging) UnityEngine.Debug.Log("Normcore Package Manager: Checking if Normcore is installed");
        ...
        private static void CheckListRequestProgress() {
            ...
            if (__listRequest.IsCompleted) {
                if (__listRequest.Status == StatusCode.Success) {
                    ...
                    if (__debugLogging) UnityEngine.Debug.Log("Normcore Package Manager: Normcore found: " + normcoreFound);
        ...
        private static bool AddScopedRegistryIfNeeded() {
            ...
            if (packageManifest == null) {
                UnityEngine.Debug.LogError("Normcore Package Manager: Failed to read project package manifest. Unable to add Normcore.");
                return false;
            }
            ...
            if (normalRegistryFound) {
                if (__debugLogging) UnityEngine.Debug.Log("Normcore Package Manager: Found Normal registry");
                return true;
            }
            ...
            if (__debugLogging) UnityEngine.Debug.Log("Normcore Package Manager: Added Normal registry");
        ...
        private static void AddPackage() {
            if (__addRequest != null) {
                UnityEngine.Debug.LogError("Normcore Package Manager: Add request already running. Ignoring.");
                return;
            }

            UnityEngine.Debug.Log("Normcore Package Manager: Adding Normcore package to project.");
        ...
        private static void CheckAddRequestProgress() {
            ...
            if (__addRequest.IsCompleted) {
                if (__addRequest.Status == StatusCode.Success) {
                    if (__debugLogging) UnityEngine.Debug.Log("Normcore Package Manager: Success!");
                } else if (__addRequest.Status >= StatusCode.Failure)
                    UnityEngine.Debug.LogError("Normcore Package Manager: Failed to add normcore package: " + __addRequest.Error.message);
